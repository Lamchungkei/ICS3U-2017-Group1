...
class SettingScene(Scene):
    def setup(self):
        ...
        self.skins_choose_label = LabelNode(text = "Skins options:",
                                    font = ('Chalkduster', 40),
                                     color = 'black',
                                    parent = self,
        ...
        original_skin_position.y = self.screen_center_y
        ...
        flashback_skin_position.y = self.screen_center_y
        ...
        panda_skin_position.y = self.screen_center_y
        ...
        poker_skin_position.y = self.screen_center_y
